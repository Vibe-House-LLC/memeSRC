...
CollageImagesStep.defaultProps = {
  ...
  borderThicknessOptions: [ { label: "None", value: 0 }, { label: "Thin", value: 4 }, { label: "Medium", value: 8 }, { label: "Thicc", value: 16 }, { label: "Thiccer", value: 28 }, { label: "XTRA THICC", value: 48 } ],
  panelImageMapping: {},
