...
const CanvasCollagePreview = ({
  ...
  const checkTextColorScrollPosition = useCallback(() => {
    ...
    // Use a small threshold to detect scrollability
    const threshold = 5;
    ...
    // Update state directly - the optimization was causing issues
