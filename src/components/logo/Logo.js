...
const Logo = forwardRef(({ sx, color = 'white', ...other }, ref) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="logo_grad_1" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(6.07497e-15,-99.2118,99.2118,6.07497e-15,278.569,271.493)">
          <stop offset="0" stopColor={colorStop1} />
          <stop offset="1" stopColor={colorStop2} />
        </linearGradient>
        <linearGradient id="logo_grad_2" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(2.54706e-14,-415.967,415.967,2.54706e-14,359.704,437.058)">
