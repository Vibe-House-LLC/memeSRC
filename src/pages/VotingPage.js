                                        ...
                                        <Box display="flex" alignItems="center">
                                            <Box mr={2}>
                                                {votingStatus[show.id] === 1 ?
                                                    ...
                                                    :
                                                    <IconButton aria-label="upvote" onClick={() => user ? handleUpvote(idx) : navigate(`/login?dest=${encodeURIComponent(location.pathname)}`)} disabled={userVotes[show.id] || votingStatus[show.id]}>
                                                ...
                                                {votingStatus[show.id] === -1 ?
                                                    ...
                                                    :
                                                    <IconButton aria-label="downvote" onClick={() => user ? handleDownvote(idx) : navigate(`/login?dest=${encodeURIComponent(location.pathname)}`)} disabled={userVotes[show.id] || votingStatus[show.id]}>
