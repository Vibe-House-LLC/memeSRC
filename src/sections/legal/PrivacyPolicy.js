...
export default function PrivacyPolicy() {
  return (
    ...
    <>
      <Helmet>
        <title> Privacy Policy • memeSRC </title>
      </Helmet>
      ...
      <StyledRoot>
        ...
        <Container maxWidth="md">
          <StyledContent>
            ...
            <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the memeSRC website.</p>
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at memeSRC.com, unless otherwise defined in this Privacy Policy.</p>
            ...
            <ul>
              <li key="facilitate">To facilitate our Service;</li>
              <li key="provide">To provide the Service on our behalf;</li>
              <li key="perform">To perform Service-related services; or</li>
              <li key="assist">To assist us in analyzing how our Service is used.</li>
            </ul>
