  ...
  const routes = useRoutes([
    {
      ...
      children: [
        ...
        { path: 'frame/:cid/:season/:episode/:frame', element: <SiteWideMaintenance><IpfsSearchBar showSearchBar={false}><V2FramePage /></IpfsSearchBar></SiteWideMaintenance> },
        { path: 'editor/:cid/:season/:episode/:frame', element: <SiteWideMaintenance><IpfsSearchBar showSearchBar={false}><V2EditorPage /></IpfsSearchBar></SiteWideMaintenance> },
        { path: 'frame/:cid/:season/:episode/:frame/:fineTuningIndex', element: <SiteWideMaintenance><IpfsSearchBar showSearchBar={false}><V2FramePage /></IpfsSearchBar></SiteWideMaintenance> },
        { path: 'editor/:cid/:season/:episode/:frame/:fineTuningIndex', element: <SiteWideMaintenance><IpfsSearchBar showSearchBar={false}><V2EditorPage /></IpfsSearchBar></SiteWideMaintenance> },
